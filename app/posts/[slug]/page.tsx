  ...
  try {
    ...
    return (
      <div className="min-h-screen bg-background">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-16 lg:px-16 py-12 sm:py-16">
          ...
          <Card>
            ...
            <CardContent className="px-4 sm:px-12 md:px-16 lg:px-20 py-8 sm:py-10">
              <article
                className="prose prose-base sm:prose-lg md:prose-xl prose-neutral dark:prose-invert max-w-none prose-headings:font-heading prose-headings:font-bold prose-p:leading-relaxed prose-a:text-primary prose-code:text-foreground prose-pre:bg-muted"
